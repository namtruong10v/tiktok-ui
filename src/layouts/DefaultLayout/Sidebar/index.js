        ...
        <aside className={cx('wrapper')}>
           <nav className={cx("tiktok-1rvr9ul-NavMainNavContainer")}>
                <ul className={cx("tiktok-nwhccz-UlMainNav")}>
                    <li>
                        <div>
                            <a className={cx("tiktok-12zznuq-StyledLink-StyledTmpLink ")}>
                            ...
                            <span className="tiktok-1bg8snk-SpanMainNavText e14l9ebt7">Dành cho bạn</span>
                            </a>
                        </div>
                    </li>
                    <li>
                        <div>
                            ...
                            <span className="tiktok-138u7nq-SpanMainNavText e14l9ebt7">Đang Follow</span>
                            </a>
                        </div>
                    </li>
                    <li>
                        <div>
                            ...
                            <svg fill="rgba(22, 24, 35, 1)" width="1em" height="1em" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M24 37.4a13.4 13.4 0 100-26.8 13.4 13.4 0 000 26.8zM40.5 24a16.5 16.5 0 11-33 0 16.5 16.5 0 0133 0z" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M27.13 27.18a2 2 0 00.93-1.32l1.84-9.33a.6.6 0 00-.9-.63l-8.14 4.92a2 2 0 00-.92 1.32l-1.84 9.33c-.1.52.45.9.9.63l8.13-4.92zm-5.04-.45l3.11-1.89.7-3.57-3.1 1.89-.7 3.57z" />
                            </svg>
                            <span className="tiktok-138u7nq-SpanMainNavText e14l9ebt7">Khám phá</span>
                            </a>
                        </div>
                    </li>
                    <li>
                        <div>
                            <a   className="tiktok-118dbw7-ALink-StyledTmpLink ">
                            ...
                            <span className="tiktok-138u7nq-SpanMainNavText e14l9ebt7">LIVE</span>
                            </a>
                        </div>
                    </li>
                </ul>
