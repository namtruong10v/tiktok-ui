        ...
        <aside className={cx('wrapper')}>
            <nav className={cx("tiktok-1rvr9ul-NavMainNavContainer")}>
                <ul className={cx("tiktok-nwhccz-UlMainNav")}>
                    <li>
                        <div>
                            <Link to='/' className={cx("tiktok-12zznuq-StyledLink-StyledTmpLink")}>
                    ...
                    <li>
                        <div>
                            <Link to='/following' className={cx("tiktok-12zznuq-StyledLink-StyledTmpLink")}>
                    ...
                    <li>
                        <div>
                            <Link to='/live' className={cx("tiktok-12zznuq-StyledLink-StyledTmpLink")}>
