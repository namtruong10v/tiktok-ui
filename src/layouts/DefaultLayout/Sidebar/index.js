    ...
    return (
        <aside className={cx('wrapper')}>
            <nav className={cx("tiktok-1rvr9ul-NavMainNavContainer")}>
                <ul className={cx("tiktok-nwhccz-UlMainNav")}>
                    <li>
                        <div>
                            <NavLink to='/' className={(nav) => cx("tiktok-12zznuq-StyledLink-StyledTmpLink", { active: nav.isActive })}>
                                <svg width={32} data-e2e height={32} viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className={cx("tiktok-138u7nq-SpanMainNavText", "e14l9ebt7")}>{t('sidebar.for_you')}</span>
                            </NavLink>
                        </div>
                    </li>
                    <li>
                        <div>
                            <NavLink to='/following' className={(nav) => cx("tiktok-12zznuq-StyledLink-StyledTmpLink", { active: nav.isActive })}>
                    ...
                    <li>
                        <div>
                            <NavLink to='/live' className={(nav) => cx("tiktok-12zznuq-StyledLink-StyledTmpLink", { active: nav.isActive })}>
                                ...
                                <span className={cx("tiktok-138u7nq-SpanMainNavText", "e14l9ebt7")}>{t('sidebar.live')}</span>
                            </NavLink>
                        </div>
                    </li>
